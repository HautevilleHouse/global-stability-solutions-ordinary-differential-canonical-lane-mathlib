...
import HautevilleHouse.GlobalStabilitySolutionsOrdinaryDifferential.FinalTheorem
...
def mathlibProofObligation : MathlibProofObligation := {
  sourceKey := "global-stability-solutions-ode",
  theoremObject := "Global stability of ODE systems via Lyapunov methods",
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedGlobalStabilityClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_global_stability_endgame A
